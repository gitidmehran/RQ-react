    ...
    <>
      <style
        dangerouslySetInnerHTML={{
          __html: `
      .ant-select-selector { 
         transition: background-color .5s cubic-bezier(0.4, 0, 0.2, 1) !important;
      ...
      .ant-select-selection-placeholder{ transition: color .5s cubic-bezier(0.4, 0, 0.2, 1) !important;}
    `,
