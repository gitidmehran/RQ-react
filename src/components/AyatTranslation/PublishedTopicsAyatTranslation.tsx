...
import { TopicAyatProps, AyatTranslations } from "../../Types/Translations";
import { EyeOutlined } from "@ant-design/icons";
const { Text } = Typography;
const PublishedTopicAyatTranslation: React.FC<TopicAyatProps> = ({
  arabic,
  translations,
  ayatId,
  surahId,
                          ...
                          >
                            {item.note !== "" && (
                              <Tooltip title="View Translation Details" color={'#2db7f5'}>
                                <a href={`${mainUrl}/ayatNotes/` + item.note} target="_blank" rel="noreferrer"><EyeOutlined style={{ color: '#2db7f5', marginRight: '3px' }} /></a>
                              </Tooltip>
                            )
                            }
                            <Text strong>{item.translation}
                      ...
                      >
                        <Row style={{ marginTop: "10px" }}>
                          ...
                          >
                            ...
                            {item.note !== "" && (
                              <Tooltip title="View Translation Details" color={'#2db7f5'} >
                                <a href={`${mainUrl}/ayatNotes/` + item.note}><EyeOutlined style={{ color: '#2db7f5', marginRight: '3px' }} /></a>
                              </Tooltip>
                            )
                            }
                          </Col>
...
export default PublishedTopicAyatTranslation;
